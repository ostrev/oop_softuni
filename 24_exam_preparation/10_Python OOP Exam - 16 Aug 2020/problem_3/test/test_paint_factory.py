...
class FactoryTest(TestCase):
    ...
    def test_add_if_type_not_in_ingredients_list(self):
    ...
    def test_add_if_can_add_return_false(self):
    ...
    def test_add_if_product_type_is_not_in_ingredients_dict(self):
        self.paint_factory.ingredients["white"] = 2
    ...
    def test_products_property(self):
        self.paint_factory.add_ingredient('white', 10)
        self.assertEqual(self.paint_factory.products, {'white': 10})
